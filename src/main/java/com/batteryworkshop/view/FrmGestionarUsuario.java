...
public class FrmGestionarUsuario extends javax.swing.JInternalFrame {
    ...
    public static void listar(String texto) {
        //agregar columnas
        String columnas[] = {"#", "Documento", "Nombre", "Email", "Telefono","Edad","Rol","","", ""};
...
//        }
        ...
        for (Object obj : lista) {
            ...
            modelo.addRow(new Object[]{
                ...
                usu.getCorreo() ,
                usu.getTelefono(),
                hoy.getYear() - usu.getFechaNacimiento().getYear() - 1900,
                usu.getRol().toString(),
                botonModificar,
                botonEliminar,
                botonVer
        ...
        tbListado.getColumnModel().getColumn(6).setPreferredWidth(100);
    ...
    private void cmdAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAgregarActionPerformed
        FrmMenuPrincipal.centrarVentana(new FrmRegistrarUsuario());
...
//                          
                            ...
                            int opcion = JOptionPane.showConfirmDialog(null, "¿Está seguro de eliminar el Usuario " + valor + "?", "Confirmar", 2);
                            if (opcion == 0) {

                                try {
                                    usuarioC.eliminar(id);
...
//                            Alerta alerta = new Alerta("Alerta", "Debe seleccionar un Rol");
                            ...
                            FrmRegistrarUsuario.idUsuario = id;
                            FrmMenuPrincipal.centrarVentana(new FrmRegistrarUsuario());
                            FrmRegistrarUsuario.cmdGrabar.setText("Modificar");
...
//                            Alerta alerta = new Alerta("Alerta", "Debe seleccionar un tipo");
                            ...
                            FrmRegistrarUsuario.vista = true;
                            FrmRegistrarUsuario.idUsuario = id;
                            FrmMenuPrincipal.centrarVentana(new FrmRegistrarUsuario());
                        }
                    }
